...
export const resultTypes = {
  "combat-frontline-pressure-risk": {
    ...
    imageSrc: "/images/results/01_combat-frontline-pressure-risk.png",
  ...
  "combat-frontline-pressure-safe": {
    ...
    imageSrc: "/images/results/02_combat-frontline-pressure-safe.png",
  ...
  "combat-frontline-design-risk": {
    ...
    imageSrc: "/images/results/03_combat-frontline-design-risk.png",
  ...
  "combat-support-pressure-safe": {
    ...
    imageSrc: "/images/results/06_combat-support-pressure-safe.png",
  ...
  "combat-support-design-risk": {
    ...
    imageSrc: "/images/results/07_combat-support-design-risk.png",
  ...
  "combat-support-design-safe": {
    ...
    imageSrc: "/images/results/08_combat-support-design-safe.png",
  ...
  "position-frontline-pressure-safe": {
    ...
    imageSrc: "/images/results/10_position-frontline-pressure-safe.png",
  ...
  "position-frontline-design-risk": {
    ...
    imageSrc: "/images/results/11_position-frontline-design-risk.png",
  ...
  "position-support-pressure-risk": {
    ...
    imageSrc: "/images/results/13_position-support-pressure-risk.png",
  ...
  "position-support-pressure-safe": {
    ...
    imageSrc: "/images/results/14_position-support-pressure-safe.png",
  ...
  "position-support-design-risk": {
    ...
    imageSrc: "/images/results/15_position-support-design-risk.png",
  ...
  "position-support-design-safe": {
    ...
    imageSrc: "/images/results/16_position-support-design-safe.png",
