...
function renderRunner(h, { status, screen = "questions", navigating = false, completionPending = false }) {
  // Controlled hook state renders the real fieldset/footer and resume callbacks.
  const values = [h.state.progress, screen, navigating, false, "", "", false, false, status, completionPending];
  let index = 0;
